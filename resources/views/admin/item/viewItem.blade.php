                        ...
                        <div class="card-header border-0">
                            <div class="row align-items-center">
                                ...
                                <div class="col-4 text-right">
                                    <a href="{{url('Item/create')}}" class="btn btn-sm btn-primary">{{ __('Add New Item') }}</a>
                                </div>
                            </div>
                        </div>
                                                ...
                                                <td>                            
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        u-right dropdown-menu-arrow">
                                                            <a class="dropdown-item" href="{{url('Item/'.$item->id)}}">{{ __('View Item') }}</a>
                                                            <a class="dropdown-item" href="{{url('Item/'.$item->id.'/edit')}}">{{ __('Edit') }}</a>
                                                            <a class="dropdown-item" onclick="deleteData('Item','{{$item->id}}');" href="#">{{ __('Delete') }}</a>
