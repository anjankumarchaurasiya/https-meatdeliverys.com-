                        ...
                        <div class="card-body shop-detail">
                            <div class="row">
                                ...
                                <div class="col-6">
                                    ...
                                    <p class="m-0">{{__("Category:")}} {{$data->category->name}}</p>
                                    <p class="m-0"> {{__('Shop:')}} {{$data->shop->name}}</p>
                                    @if ($data->isVeg==1)
                                    <p class="b-1"><i class="fas fa-seedling mr-2 text-success"></i> {{__('Pure Veg')}}</p>
                                    @else 
                                    <p><i class="fas fa-utensils text-danger mr-2"></i>{{__('Non-veg')}}</p>
                                    @endif                                    
                                </div>
                            </div>                           
                        </div>
