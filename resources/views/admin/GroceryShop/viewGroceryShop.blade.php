                    ...
                    <div class="card form-card shadow">
                        <div class="card-header border-0">
                            <div class="row align-items-center">
                                ...
                                <div class="col-8">
                                    <h3 class="mb-0">{{ __('Grocery Shops') }}
                                ...
                                <table class="table align-items-center table-flush">
                                    <thead class="thead-light">
                                        <tr>
                                            ...
                                            <th scope="col">{{ __('Assign all product') }}</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        @foreach ($shops as $shop)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{url('assignProductToShop/'.$shop->id)}}">
                                                       <button class="btn btn-sm btn-success">Assign all products</button>
                                                    </a>
                                                </td>
                                            </tr>
                                        @endforeach
