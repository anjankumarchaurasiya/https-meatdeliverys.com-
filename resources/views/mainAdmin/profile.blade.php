        ...
        <div class="row">
                ...
                <div class="card card-profile shadow">
                    <div class="row justify-content-center">
                        <div class="col-lg-3 order-lg-2">
                            <div class="card-profile-image">
                                <a href="#">
                                    <img src="{{url('images/upload/'.Auth::guard('mainAdmin')->user()->image)}}" style="border: 5px solid #fff;" class="rounded-circle">
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body pt-0 pt-md-4">
                        ...
                        <div class="text-center">
                            ...
                            <div class="h5 mt-4">
                                <i class="ni business_briefcase-24 mr-2"></i>{{ __('Admin') }}
                            </div>                                                   
                        </div>
                    </div>
                </div>
            ...
            <div class="col-xl-8 order-xl-1">
                <div class="card bg-secondary shadow">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{url('editAdminProfile')}}" autocomplete="off"  enctype="multipart/form-data">
                            @csrf
                        ...
                        <hr class="my-4"/>
                        <form method="post" action="{{url('changeAdminPassword')}}" autocomplete="off">
                            @csrf
