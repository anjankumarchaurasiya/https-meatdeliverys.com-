                                ...
                                <form method="post" action="{{url('updateDriver/'.$data->id)}}" autocomplete="off" enctype="multipart/form-data" >
                                    ...
                                    <div class="pl-lg-4">
                                        ...
                                        <div class="form-group{{ $errors->has('driver_radius') ? ' has-danger' : '' }}">
                                            ...
                                            <input type="number" name="driver_radius" min="1" id="input-driver_radius" class="form-control form-control-alternative{{ $errors->has('driver_radius') ? ' is-invalid' : '' }}" placeholder="{{ __('Radius') }}" value="{{ $data->driver_radius }}" required>
