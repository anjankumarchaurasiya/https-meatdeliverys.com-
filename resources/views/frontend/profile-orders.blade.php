                                        ...
                                        <div class="order-body10">
                                            ...
                                            <div class="track-order">
                                                ...
                                                <div class="bs-wizard" style="border-bottom:0;">   
                                                    <div class="bs-wizard-step {{ $status == "Pending" || $status == "Approved" || $status == "Prepare" ? 'active':'complete' }}">
                                                        <div class="text-center bs-wizard-stepnum">{{__('Placed')}}</div>
                                                        <div class="progress"><div class="progress-bar"></div></div>
                                                        <a href="#" class="bs-wizard-dot"></a>
                                                    </div>
                                                    
                                                    <div class="bs-wizard-step {{ $status == "Pending" || $status == "Approved" || $status == "Prepare" ? 'disabled':'' }}{{ $status == "OrderReady" || $status == "DriverReach" || $status == "DriverApproved" || $status == "DriverAtShop" ? 'active':'' }}{{ $status == "OutOfDelivery" || $status == "PickUpGrocery" || $status == "OneTheWay" || $status == "Delivered" ? 'complete':''  }}">
                                                        <div class="text-center bs-wizard-stepnum">{{__('Packed')}}</div>
                                                        <div class="progress"><div class="progress-bar"></div></div>
                                                        <a href="#" class="bs-wizard-dot"></a>
                                                    </div>
                                                    <div class="bs-wizard-step {{ $status == "Pending" || $status == "Approved" || $status == "Prepare" || $status == "OrderReady" || $status == "DriverReach" || $status == "DriverApproved" || $status == "DriverAtShop" ? 'disabled':'' }}{{ $status == "OutOfDelivery" || $status == "PickUpGrocery" || $status == "OneTheWay" ? 'active':''  }}{{ $status == "Delivered" ? 'complete':'' }}">
                                                        <div class="text-center bs-wizard-stepnum">{{__('On the way')}}</div>
                                                        <div class="progress"><div class="progress-bar"></div></div>
                                                        <a href="#" class="bs-wizard-dot"></a>
                                                    </div>
                                                    <div class="bs-wizard-step {{ $status == "Delivered" ? 'active':'disabled' }}">
                                                        <div class="text-center bs-wizard-stepnum">{{__('Delivered')}}</div>
                                                        <div class="progress"><div class="progress-bar"></div></div>
                                                        <a href="#" class="bs-wizard-dot"></a>
                                                    </div>
                                                </div>
