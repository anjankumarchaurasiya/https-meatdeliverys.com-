...
<div class="bs-canvas bs-canvas-left position-fixed bg-cart h-100" id="cart">
					...
					<div class="cart-item" id="cart-item-{{$item['id']}}" >
						...
						<div class="cart-text">
							...
							<div class="cart-radio">
								...
								<input type="hidden" name="cart-item-detail-index-id" value="0" class="cart-item-detail-index-{{$item['id']}} ">
								<ul class="kggrm-now">
							...
							<button type="button" class="cart-close-btn"  id="cart-close-btn-{{$item['id']}}" data-id="{{$item['id']}}"><i class="uil uil-multiply"></i></button>
						</div>
					</div>
				@endforeach
			@endif
	...
	<div class="bs-canvas-footer">
      ...
      @if(($total + $setting->delivery_charge - $discount) !== 0)
