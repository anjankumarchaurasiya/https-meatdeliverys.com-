                            ...
                            <div class="form-dt">
                                <div class="form-inpts checout-address-step">
                                    <form action="{{url('/check-otp')}}" method="post">
                                        @csrf
                                        <div class="form-title"><h6>{{__('Verify-OTP')}} </h6>You will have to verify your email id by entering the OTPs sent on your email id. Please check your spam folder if you are not receiving otp on your email id.</div>
                                        <div class="form-group pos_rel">
                                            <input id="otp" name="otp" type="text" placeholder="{{__('Enter OTP')}}" class="form-control lgn_input">
                                            <i class="uil uil-envelope-send lgn_icon"></i>
                                        </div>
                                        @if($errors->any())
