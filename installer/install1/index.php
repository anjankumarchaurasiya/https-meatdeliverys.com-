...
break;
            ...
            if ($activate_response['status'] != true) {?>
                      <form action="index.php?step=0" method="POST">
                        ...
                        <input type="hidden" name="client_name" id="client_name" value="<?php echo $client_name; ?>">
                          ...
                          <div class="control">
                            <input class="input" type="text" placeholder="enter your purchase/license code" name="license" value="nulled" required>
                          </div>
                        </div>
                        <div class="field">
                          <label class="label">Your name</label>
                          <div class="control">
                            <input class="input" type="text" placeholder="enter your name/envato username" name="client" value="name" required>
                          </div>
                        </div>
                        <div style='text-align: right;'>
                    ...
                    <form action="index.php?step=0" method="POST">
                      ...
                      <div class="field">
                        <label class="label">Your name</label>
                        <div class="control">
                          <input class="input" type="text" placeholder="enter your name/envato username" value="nulled" name="client" required>
                        </div>
                      </div>
                      <div style='text-align: right;'>
                        <button type="submit" class="button is-link">Verify</button>
  ...
  <div class="content has-text-centered">
    ...
    <p>© <?php echo date('Y'); ?> Copyright Gambo by <a  target="_blank"  href="http://saasmonks.in/">Saas Monks</a></p><br>
  </div>
</body> 
