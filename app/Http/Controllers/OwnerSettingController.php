...
class OwnerSettingController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.setting.setting',['point'=>$point,'data'=>$data,'companyData' => $companySetting, 'language' => $language, 'paymentData' => $paymentSetting, 'setting' => $setting, 'currency' => $currency]);
    }
